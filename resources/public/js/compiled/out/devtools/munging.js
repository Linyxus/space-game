...
var o39995 = temp__5276__auto__;
var temp__5276__auto____$1 = (o39995["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o39996 = temp__5276__auto____$1;
return (o39996["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39076__auto__ = f;
return (o__39076__auto__["toString"]).call(o__39076__auto__);
} else {
return "";
}
}catch (e39997){var _ = e39997;
return "";
}});
...
try{var o__39076__auto___39999 = t;
(o__39076__auto___39999["cljs$lang$ctorPrWriter"]).call(o__39076__auto___39999,t,writer);
}catch (e39998){var __40000 = e39998;
}
...
var char_code = (function (){var o__39076__auto__ = (new String(char$));
return (o__39076__auto__["charCodeAt"]).call(o__39076__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39076__auto__ = String;
return (o__39076__auto__["fromCharCode"]).call(o__39076__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40001 = num_code;
switch (G__40001) {
case (1):
return (185);
...
var o__39076__auto__ = String;
return (o__39076__auto__["fromCharCode"]).call(o__39076__auto__,superscript_code);
});
/**
...
}catch (e40003){var _e__39083__auto__ = e40003;
return false;
}})())){
...
var vec__40004 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40004,(0),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var o40007 = temp__5276__auto__;
var temp__5276__auto____$1 = (o40007["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o40008 = temp__5276__auto____$1;
return (o40008["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31325__auto___40015 = arguments.length;
var i__31326__auto___40016 = (0);
while(true){
if((i__31326__auto___40016 < len__31325__auto___40015)){
args__31332__auto__.push((arguments[i__31326__auto___40016]));

var G__40017 = (i__31326__auto___40016 + (1));
i__31326__auto___40016 = G__40017;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40011){
var vec__40012 = p__40011;
var ns_detector = cljs.core.nth.call(null,vec__40012,(0),null);
...
var G__40018 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40019 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40018;
remaining_tokens = G__40019;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40009){
var G__40010 = cljs.core.first.call(null,seq40009);
var seq40009__$1 = cljs.core.next.call(null,seq40009);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__40010,seq40009__$1);
});
...
var vec__40023 = cljs.core.split_with.call(null,(function (p1__40022_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40022_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40023,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40023,(1),null);
...
var vec__40026 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40026,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40026,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40029 = cljs.core.rest.call(null,remaining_tokens);
var G__40030 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40029;
name_tokens = G__40030;
continue;
} else {
...
var vec__40033 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40033,(0),null);
var arity = cljs.core.nth.call(null,vec__40033,(1),null);
var vec__40036 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40036,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40036,(1),null);
var vec__40039 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40039,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40039,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40039,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40039,(3),null);
...
var vec__40045 = result;
var munged_ns = cljs.core.nth.call(null,vec__40045,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40045,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40045,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40045,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40045,(4),null);
var arity = cljs.core.nth.call(null,vec__40045,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__40049 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__40049,(0),null);
var args = cljs.core.nth.call(null,vec__40049,(1),null);
var vec__40052 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40052,(0),null);
var name = cljs.core.nth.call(null,vec__40052,(1),null);
...
var G__40055 = (arity + (1));
var G__40056 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40057){
var vec__40058 = p__40057;
var arity = cljs.core.nth.call(null,vec__40058,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40058,(1),null);
...
return cljs.core.get.call(null,arities,p1__40061_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__40062_SHARP_);
...
var args__31332__auto__ = [];
var len__31325__auto___40069 = arguments.length;
var i__31326__auto___40070 = (0);
while(true){
if((i__31326__auto___40070 < len__31325__auto___40069)){
args__31332__auto__.push((arguments[i__31326__auto___40070]));

var G__40071 = (i__31326__auto___40070 + (1));
i__31326__auto___40070 = G__40071;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40065){
var vec__40066 = p__40065;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40066,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40063){
var G__40064 = cljs.core.first.call(null,seq40063);
var seq40063__$1 = cljs.core.next.call(null,seq40063);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__40064,seq40063__$1);
});
...
var G__40072 = arg;
var G__40072__$1 = (((G__40072 instanceof cljs.core.Keyword))?G__40072.fqn:null);
switch (G__40072__$1) {
...
var map__40074 = options;
var map__40074__$1 = ((((!((map__40074 == null)))?((((map__40074.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40074.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40074):map__40074);
var include_ns_QMARK_ = cljs.core.get.call(null,map__40074__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40074__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40074__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40074__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40075 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40075,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40075,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40075,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40075,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40075,(4),null);
var arity = cljs.core.nth.call(null,vec__40075,(5),null);
...
var o__39076__auto__ = f;
return (o__39076__auto__["getBasis"]).call(o__39076__auto__);
});
/**
...
}catch (e40079){var _e__39083__auto__ = e40079;
...
var G__40080 = (obj[cljs.core.first.call(null,path)]);
var G__40081 = cljs.core.rest.call(null,path);
obj = G__40080;
path = G__40081;
continue;
} else {
...
return (function (accum,p__40082){
var vec__40083 = p__40082;
var bit = cljs.core.nth.call(null,vec__40083,(0),null);
var protocol = cljs.core.nth.call(null,vec__40083,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40086){
var vec__40087 = p__40086;
var ns = cljs.core.nth.call(null,vec__40087,(0),null);
var name = cljs.core.nth.call(null,vec__40087,(1),null);
var selector = cljs.core.nth.call(null,vec__40087,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__40092,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40092,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__40092,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40090_SHARP_){
return (obj[cljs.core.first.call(null,p1__40090_SHARP_)]);
});})(name,sorted_matches,vec__40092,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1509168665915
