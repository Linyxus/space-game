...
var file = cljs.core.get.call(null,map__41892__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__41892__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__41892__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e41891){var _e = e41891;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5276__auto___41894 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5276__auto___41894)){
var seen_errors_41895 = temp__5276__auto___41894;
if(cljs.core.truth_(seen_errors_41895.has(self))){
} else {
seen_errors_41895.add(self);

var temp__5278__auto___41896 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5278__auto___41896)){
var sense_41897 = temp__5278__auto___41896;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_41897)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1509168668415
