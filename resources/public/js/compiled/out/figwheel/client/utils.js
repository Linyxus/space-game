...
return (new CustomEvent(event_name,(function (){var obj36788 = {"detail":data};
return obj36788;
})()));
} else {
...
var f = (function (){var pred__36795 = cljs.core._EQ_;
var expr__36796 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36795.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36796))){
return ((function (pred__36795,expr__36796){
return (function (p1__36789_SHARP_){
return console.warn(p1__36789_SHARP_);
});
;})(pred__36795,expr__36796))
} else {
if(cljs.core.truth_(pred__36795.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36796))){
return ((function (pred__36795,expr__36796){
return (function (p1__36790_SHARP_){
return console.debug(p1__36790_SHARP_);
});
;})(pred__36795,expr__36796))
} else {
if(cljs.core.truth_(pred__36795.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36796))){
return ((function (pred__36795,expr__36796){
return (function (p1__36791_SHARP_){
return console.error(p1__36791_SHARP_);
});
;})(pred__36795,expr__36796))
} else {
return ((function (pred__36795,expr__36796){
return (function (p1__36792_SHARP_){
return console.log(p1__36792_SHARP_);
});
;})(pred__36795,expr__36796))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36799){
...
var eval_fn = cljs.core.get.call(null,map__36800__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__36802_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__36804,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1509168662868
